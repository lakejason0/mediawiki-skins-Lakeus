...
## mediawiki-skins-Lakeus 1.5.0+REL1.43

This is the first release of the mediawiki-skins-Lakeus 1.5 version.

### Configuration changes for system administrators in 1.5.0+REL1.43

#### New configuration in 1.5.0+REL1.43
